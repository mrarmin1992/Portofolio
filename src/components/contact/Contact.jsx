...
const Contact = () => {
  ...
  return (
    <section id="contact">
      <h2 data-aos="flip-left">Need a Full Stack Developer?</h2>
        ...
        <div className="contact_options" data-aos="zoom-in-right">
          ...
          <Tilt>
            <div className="contact_option">
              <a href="mailto:armin.pezo@gmail.com" target="_blank">
                <AiOutlineMail
                  style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}
                  className="animate__animated animate__headShake animate__infinite"
                />
                <h4>E-mail</h4>
                <p>armin.pezo@gmail.com</p>
                <p>Send message</p>
              </a>
            </div>
          </Tilt>
          <Tilt>
            <div className="contact_option">
              <a
                href="https://api.whatsapp.com/send?phone=38762359197"
                target="_blank"
              >
                <AiOutlineWhatsApp
                  style={{ fontSize: "1.5rem", marginBottom: "0.5rem" }}
